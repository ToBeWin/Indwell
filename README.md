...
- Agent run audit: trigger, retrieved memories, written memories, exposed tools, policy blocks, provider output summary, including channel and mock voice turns.
